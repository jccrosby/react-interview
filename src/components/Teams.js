    ...
    return (
        <>
            ...
            <p>
                ...
                <pre>https://statsapi.mlb.com/api/v1/teams?season=2021&amp;sportId=1</pre>
                From there we want to display each team and the members of each team. To get the
                members of each team call the stats API with the team ID - GET to{' '}
                <pre>http://statsapi.mlb.com/api/v1/teams/{teamId}/roster?rosterType=active</pre>
            </p>
            <h2>Bonus</h2>
            <p>Add some styling to the component to make it more presentable or create one to two unit tests for the project.</p>
        </>
    );
};
